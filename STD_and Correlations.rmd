...
The primary objective of the accompanying R code is to empirically evaluate the stylised facts of the United States business cycle over a forty-three-year period spanning from Q1 1982 to Q3 2025. Specifically, it is constructed to obtain key macroeconomic time-series data, filter out long-term structural trends, and compute crucial second-order moments, being standard deviations and correlation coefficients.
